...
<body>
<form class="problem" action="none_policiesform.php" method="POST" enctype="multipart/form-data">
  <div class="mb-3">
        <label for="exampleFormControlInput1" class="form-label">Please enter your Parent/Guardian's Occupation:</label>
        <input type="text" class="form-control" name="occupation" required>
      </div>
      <br>
    <div class="mb-3">
        <label for="exampleFormControlInput1" class="form-label">Please enter your Parent/Guardian's Annual Income:</label>
        <input type="text" class="form-control" name="annual_income"  placeholder="in Rupees" required>
      </div>
      <br>
    <div class="mb-3">
        <label for="exampleFormControlTextarea1" class="form-label">Please enter your Parent/Guardian's Income Certificate:</label>
